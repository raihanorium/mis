...
<ul id="menuGrid" class="kendoGridMenu">
    <sec:access url="/${propertyName}/update">
        <li onclick="select${className}();"><i class="fa fa-edit"></i>Edit</li>
    </sec:access>
...
<script language="javascript">
    ...
    function onLoad${className}Page() {
        ...
        // update page title
        \$(document).attr('title', "${FormatUtil.getPrefixString(className)} - Create ${FormatUtil.getNameString(className)}");
